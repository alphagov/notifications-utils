...
@pytest.mark.parametrize(
    'template_class, template_type, extra_attributes', [
        ...
        (SMSPreviewTemplate, 'sms', 'class="govuk-link govuk-link--no-visited-state" style="word-wrap: break-word;"'),
        (BroadcastPreviewTemplate, 'broadcast', 'class="govuk-link govuk-link--no-visited-state" style="word-wrap: break-word;"'),
