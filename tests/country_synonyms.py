ALL = (
    ...
    ('czechoslovakrepublic', 'Czechoslovakia'),
    ...
    ('germanydemocraticrepublic', 'East Germany'),
    ('gf', 'French Guiana'),
    ('gg', 'Guernsey'),
    ('gh', 'Ghana'),
    ('gi', 'Gibraltar'),
    ...
    ('island', 'Iceland'),
    ('islandofguernsey', 'Guernsey'),
    ('islandofjersey', 'Jersey'),
    ...
    ('pitcairn,henderson,ducieandoenoislands', 'Pitcairn, Henderson, Ducie and Oeno Islands'),
    ('pk', 'Pakistan'),
    ('pl', 'Poland'),
    ...
    ('socialistfederalrepublicofyugoslavia', 'Yugoslavia'),
    ...
    ('southgeorgiaandthesouthsandwichislands', 'South Georgia and South Sandwich Islands'),
    ...
    ('союзсоветскихсоциалистическихреспублик', 'USSR'),
