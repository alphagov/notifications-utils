...
def redis_client_with_live_instance(app, tmp_path_factory):
    # note that this fixture cannot be used in parallel without the risk
    # of race conditions. Use the decorator @pytest.mark.xdist_group(name="group1")
    # for tests using this fixture to ensure they run on the same worker.
